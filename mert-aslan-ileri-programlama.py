...
for i in range(0,eleman_sayisi):
    toplams=toplams+liste[i]
ortalama=toplams/eleman_sayisi
ortalama_ustu=[]
for i in range(0,10):
    if liste[i]>ortalama:
...
def uus_al(taban,us):
    if taban==1:
        ...
        return taban*uus_al(taban, us-1)
...
def faktoriyel(n):
   if n==0:
       ...
       return n*faktoriyel(n-1)
sayi21=int(input("sayı giriniz"))
fak=faktoriyel(sayi21)
print(faktoriyel)
